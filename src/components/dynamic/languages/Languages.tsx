        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {LANGUAGES_DATA.map((lang, index) => (
            <motion.div 
              ...
              className="bg-dark-800/50 border border-white/5 p-6 rounded-2xl flex items-center gap-6 relative overflow-hidden group hover:bg-white/5 transition-colors"
            >
