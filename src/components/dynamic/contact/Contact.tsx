        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <a href="mailto:mxaadxatti.official@gmail.com" className="flex items-center gap-5 group p-4 rounded-2xl hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-2 text-xs text-gray-400 bg-white/5 px-2 py-1 rounded w-fit">
                    <Clock className="w-3.5 h-3.5" /> Replies within 24 hours
                  </div>
                </div>
              </a>
              <a href="https://wa.me/447393642179" target="_blank" rel="noopener noreferrer" className="flex items-center gap-5 group p-4 rounded-2xl hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
              ...
              <a href="tel:+923472788527" className="flex items-center gap-5 group p-4 rounded-2xl hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
              ...
              <motion.a whileHover={{ scale: 1.02, boxShadow: "0 0 30px rgba(139, 92, 246, 0.15)" }} href="https://www.google.com/maps/search/?api=1&query=Rawalpindi+Polytechnic+Institute" target="_blank" rel="noopener noreferrer" className="flex items-start gap-5 group p-4 rounded-2xl hover:bg-white/5 transition-all border border-transparent hover:border-primary-500/20">
                ...
                <div>
                  ...
                  <div className="text-base font-medium text-white leading-relaxed group-hover:text-primary-400 transition-colors max-w-sm">Rawalpindi Polytechnic Institute, NE273 Tipu Road, Rawalpindi (Near RMU)</div>
                  <div className="flex items-center gap-2 mt-3 text-xs font-bold text-primary-300 bg-primary-900/30 px-3 py-1.5 rounded-full w-fit border border-primary-500/20">
                    <Globe className="w-3.5 h-3.5" /> Available for Remote Work
                  </div>
                </div>
              </motion.a>
              <div className="pt-8 mt-4 border-t border-white/5">
                ...
                <div className="flex gap-4">
                  {[{ Icon: Linkedin, bg: '#0077b5' }, { Icon: Twitter, bg: '#1DA1F2' }, { Icon: Github, bg: 'white' }, { Icon: Facebook, bg: '#1877F2' }].map(({ Icon, bg }, i) => (
                    <a key={i} href="#" className="group relative">
                      <div className={`w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-gray-400 transition-all duration-300 group-hover:-translate-y-1`} style={{ '--hover-bg': bg } as any}>
            ...
            <form onSubmit={handleSubmit} className="glass-card p-8 rounded-3xl space-y-6 border border-white/10 shadow-2xl relative z-30">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setOpenDropdown(openDropdown === 'service' ? null : 'service')} className={`w-full bg-dark-800/50 border rounded-lg px-4 py-3 text-left flex items-center justify-between outline-none transition-all duration-300 ${errors.service ? 'border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.2)]' : 'border-white/10 hover:border-white/20 focus:border-primary-400 focus:ring-2 focus:ring-primary-500/20'} ${formData.service ? 'text-white' : 'text-gray-500'}`}>
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setOpenDropdown(openDropdown === 'goal' ? null : 'goal')} className={`w-full bg-dark-800/50 border rounded-lg px-4 py-3 text-left flex items-center justify-between outline-none transition-all duration-300 ${errors.goal ? 'border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.2)]' : 'border-white/10 hover:border-white/20 focus:border-primary-400 focus:ring-2 focus:ring-primary-500/20'} ${formData.goal ? 'text-white' : 'text-gray-500'}`}>
