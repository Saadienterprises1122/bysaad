      ...
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-400 text-sm">Choose from Content, Code, or Design tools.</p>
              </div>
              <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-400 text-sm">Provide code snippets, descriptions, or topics.</p>
              </div>
              <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-400 text-sm">Get optimized output instantly.</p>
              </div>
          </div>
      </div>
